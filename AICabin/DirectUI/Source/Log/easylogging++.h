...
class ELPP_EXPORT AbstractRegistry : public base::threading::ThreadSafe {
 public:
...
class ELPP_EXPORT Configurations : public base::utils::RegistryWithPred<Configuration, Configuration::Predicate> {
 public:
...
#endif  // defined(ELPP_STL_LOGGING)
// Log message builder
class ELPP_EXPORT MessageBuilder {
 public:
...
class ELPP_EXPORT Loggers : base::StaticClass {
 public:
...
// Normal logs
#define DUILOG(LEVEL) CLOG(LEVEL, ELPP_CURR_FILE_LOGGER_ID)
