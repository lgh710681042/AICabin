...
void Configurations::setToDefault(void) {
  setGlobally(ConfigurationType::Enabled, std::string("false"), true);
  ...
  setGlobally(ConfigurationType::ToStandardOutput, std::string("false"), true);
  setGlobally(ConfigurationType::SubsecondPrecision, std::string("3"), true);
  setGlobally(ConfigurationType::PerformanceTracking, std::string("false"), true);
  setGlobally(ConfigurationType::MaxLogFileSize, std::string("1048576"), true);
