...
public:
	...
	void DrawHtmlText(FontObj* pFontObjDefault, RECT& rc, LPCTSTR pstrText, DWORD dwTextColor, RECT* prcLinks, tstring* sLinks, int& nLinkRects, tstring sHoverLink,
		DWORD dwLinkColor, DWORD dwLinkHoverColor, UINT uStyle, HtmlPaintParams &paintParams, bool &bEndEllipsis, UITYPE_FONT nFontType = UIFONT_DEFAULT);
